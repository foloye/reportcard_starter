...
const studentInformation = {
  ...
  graduationYear: "2025",
  imageUrl: "https://cdn.inprnt.com/thumbs/8b/e8/8be8233c5c41f4a4e9e16d3b3b90eb15.jpg?response-cache-control=max-age=2628000",
}
...
const gradEl = document.querySelector("#student-graduation-year")
const imgEl = document.querySelector("#student-image")
const semDropEl = document.querySelector(".semester-dropdown")
const semDropBtnEl = document.querySelector(".dropdown-button")
const semDropLabelEl = document.querySelector(".dropdown-label")
const fallSemLabel = document.querySelector("#fall-semester")
const springSemLabel = document.querySelector("#spring-semester")
const winterLabel = document.querySelector("#winter-term")
...
function updateStudentGraduationYear(graduationYear) {
  gradEl.innerHTML = graduationYear;
  // code goes here
}
...
function updateReportCard(reportCardTableElement, currentSemester) {
  ...
  //addCourseRowToReportCard(reportCardEl, currentSemester[0], 0)
  Object.keys(studentData)[currentSemester].forEach(item => addCourseRowToReportCard(reportCardEl, item, item))
...
window.onload = function () {
 ...
 // addCourseRowToReportCard(reportCardEl, studentData[0], 0)
  updateReportCard(reportCardEl, studentData[semester])
